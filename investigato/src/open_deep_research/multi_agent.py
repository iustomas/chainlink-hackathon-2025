...
print("[ENV] ANTHROPIC_API_KEY:", os.getenv("ANTHROPIC_API_KEY"))
print("[ENV] TAVILY_API_KEY:", os.getenv("TAVILY_API_KEY"))
print("[ENV] GROQ_API_KEY:", os.getenv("GROQ_API_KEY"))
print("[ENV] PERPLEXITY_API_KEY:", os.getenv("PERPLEXITY_API_KEY"))
print("[ENV] EXA_API_KEY:", os.getenv("EXA_API_KEY"))
